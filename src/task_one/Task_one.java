...
/*ну что ты умеешь копировать вестку из инетернета я понял
* а теперь разнеси все по классам. Сделай класс конструктор которого принимает на вход
* имя файла и создает файл
* Второй класс должен хрнаить в себе HTML код , но его надо сделать красивым посмотри чего общего в HTML коде каждого
